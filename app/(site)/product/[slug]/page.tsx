...
export default async function ProductPage({ params }: ProductPageProps) {
  ...
  const relatedProducts = (relatedData || []).map((related) => {
    ...
    const computedRelatedStatus = related.status || "available";
  ...
  const computedStatus: ProductStatus = product.status || "available";
  const isUnavailable = computedStatus === "sold";
